...
def get_quiz_data():
    ...
    quiz_data = [
        ...
        {'오류 유형': '데/대', '문제': '어제 가보니 정말 좋[데/대] (간접 경험)', '정답': '어제 가보니 정말 좋대.', '오답들': ['어제 가보니 정말 좋데.']},
            ...
            with response_placeholder.container():
                with st.spinner("💭 생각 중..."):
                    ...
                    system_prompt = (
                        ...
                        "4. 정답 여부를 확인한 후, 친절하게 피드백을 제공하고 다음 문제를 제시해야 해.\n"
                        "\n**매우 중요 - 답변 완성도:**\n"
                        ...
                        "   - 형식: '**문제:** [문제 내용]'\n"
                        "   - 때로는 '되/돼를 구분하는 방법은 무엇인가요?' 또는 '이에요, 예요를 구분하는 방법은 무엇인가요?' 같은 질문도 제시할 수 있어요.\n"
